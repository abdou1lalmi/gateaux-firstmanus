...
export default function Home() {
  ...
  const testimonials = [
    {
      name: "Kahina M.",
      event: "Mariage à Alger",
      comment: "Les gâteaux de Zohra Korichi ont fait l'unanimité lors de notre mariage. Non seulement magnifiques visuellement, mais d'un raffinement gustatif exceptionnel !",
      rating: 5,
    },
    {
      name: "Yasmine B.",
      event: "Fiançailles",
      comment: "Un travail d'orfèvre ! Le Mkhabez et les pièces décorées étaient d'une perfection absolue. Merci pour votre professionnalisme et votre accueil chaleureux.",
      rating: 5,
    },
    {
      name: "Amine K.",
      event: "Atelier Traditionnel",
      comment: "J'ai participé à la dernière formation. Zohra partage son savoir-faire avec passion et générosité. Une expérience inoubliable.",
      rating: 5,
    },
  ];
      ...
      <main className="flex-grow">
          ...
          <div className="container relative z-10 text-cream py-12 md:py-20">
            <div className="max-w-3xl space-y-6">
              ...
              <div className="grid grid-cols-3 gap-6 pt-10 border-t border-cream/20 mt-12 max-w-xl">
                <div>
                  <p className="text-2xl sm:text-3xl font-serif font-bold text-gold">117K+</p>
        ...
        <section className="py-20 bg-charcoal text-cream relative overflow-hidden">
          <div className="absolute inset-0 z-0 opacity-20">
            <img
              src="/manus-storage/workshop_class_b2081b4a.png"
            ...
            <div className="pt-2">
              ...
              >
                <Button size="lg" className="bg-gold hover:bg-gold-dark text-charcoal font-semibold rounded-full px-8 shadow-lg">
                  ...
                  Rejoindre 117K+ Abonnés sur Instagram
                </Button>
              </a>
            </div>
          </div>
